...
- Create Angular project with ng: `ng new dailyactivityrecord.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`dailyactivityrecord.client.esproj`).
